...
<td class="ravi12"><input type="text" class="text" id="valid1" maxlength="10" name="id" onkeyup="return validate2()"/></td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
<td class="feature">Password</td>
<td class="ravi12"><input type="password" class="text" id="valid2" name="password" maxlength="20" onkeyup="return validate2()"/></td>
</tr>
<tr><td>&nbsp;</td></tr>
<?php
if(!empty($_REQUEST['s']))
...
<td class="ravi12" align="left">Remember Me</td>
</tr><tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td>
<td class="feature" ><center><input id="valid" type="submit" name="sub" value="      Login     " onclick="return validate1()"/><input type="Reset"  value="      Reset     "/></center></td></tr>
<tr><td>&nbsp;</td></tr>
<tr>
...
{
    header("location:check.php?i=$_REQUEST[id]&p=$_REQUEST[password]&z=$_SESSION[status]");
}
?>
</body>